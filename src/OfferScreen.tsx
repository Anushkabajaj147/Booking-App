  ...
  return (
    <View style={{flex:1,backgroundColor:'rgb(240, 240, 240)'}}>
      <View style={{borderWidth:1,borderColor:'transparent',height:height*0.088,width:width-10,alignSelf:'center',flexDirection:'row'}}>
        <TouchableOpacity style={{borderWidth:0.5,borderColor:'transparent',height:height*0.088,width:width-350,justifyContent:'center',alignSelf:'flex-start',alignContent:'center',alignItems:'center'}} onPress={()=>Navigation.navigate('ExploreScreen')}><Icon name='keyboard-arrow-left' size={42} color={'rgba(31, 31, 31,0.9)'} onPress={()=>Navigation.navigate('ExploreScreen')}/></TouchableOpacity>

...
const PlusMultiFunction=(string) =>{
  ...
  const MinusMultiFunction=(string)=>{
    ...
    const showSecondDropdown=(item)=>{
      setShowDropdown(false);
      setShowSecDropdown(true);
      return(
        <TouchableOpacity onPress={()=>renderSecItem(item)} style={{borderWidth:0.5}}>
        <View >
    ...
    const showFirstDropdown=(item)=>{
      setShowSecDropdown(false);
      setShowDropdown(true);
      return(
        <TouchableOpacity onPress={()=>showItems(item)} style={{borderWidth:0.5}}>
        <View >
                   <View style={{flexDirection:'row',justifyContent:'space-between'}}>
                   <Text style={{fontSize:18,justifyContent:'flex-start',alignSelf:'flex-start',left:'2%',fontWeight:'bold'}}>{item.label}</Text>
                   <Text style={{fontSize:18,justifyContent:'flex-end',alignSelf:'flex-end',right:'2%',fontWeight:'bold'}}>{item.code}</Text>
    ...
    const multiWayFirstDropdown=(item)=>{
      setMultiWayDropdownTwo(false);
      setMultiWayDropdownOne(true);
      return(
        <TouchableOpacity onPress={()=>showMultiWayFlatlistOne(item)} style={{borderWidth:0.5}}>
                       <View >
                        <View style={{flexDirection:'row',justifyContent:'space-between'}}>
                        <Text style={{fontSize:18,justifyContent:'flex-start',alignSelf:'flex-start',left:'2%',fontWeight:'bold'}}>{item.label}</Text>
                        <Text style={{fontSize:18,justifyContent:'flex-end',alignSelf:'flex-end',right:'2%',fontWeight:'bold'}}>{item.code}</Text>
    ...
    const multiWaySecondDropdown=(item)=>{
      setMultiWayDropdownOne(false);
      setMultiWayDropdownTwo(true);
      return(
        <TouchableOpacity onPress={()=>renderMultiWayDropdownTwo(item)} style={{borderWidth:0.5}}>
        <View >
                   <View style={{flexDirection:'row',justifyContent:'space-between'}}>
                   <Text style={{fontSize:18,justifyContent:'flex-start',alignSelf:'flex-start',left:'2%',fontWeight:'bold'}}>{item.label}</Text>
                   <Text style={{fontSize:18,justifyContent:'flex-end',alignSelf:'flex-end',right:'2%',fontWeight:'bold'}}>{item.code}</Text>
  ...
  return (
    <View style={{flex:1,backgroundColor:'rgb(240, 240, 240)'}}>
      ...
      {multiWay?  <View style={{borderWidth:1,borderColor:'transparent',alignSelf:'center',borderRadius:10,height:height*0.248,width:width-10,backgroundColor:'#fff',top:'5%',elevation:24}}>
                   <View style={{flexDirection:'row',alignSelf:'center'}}>
                   <View style={{alignSelf:'flex-start',position:'absolute',borderWidth:2,borderColor:'rgb(219, 188, 160)',left:'45.8%',top:'38%',borderRadius:20,backgroundColor:'rgb(219, 188, 160)'}}>
                     <Icon name='compare-arrows' size={35} color={'rgba(31, 31, 31,0.72)'}/>
                    </View>
                    <TouchableOpacity style={{borderWidth:0.5,borderColor:'rgba(31, 31, 31,0.9)',height:height*0.122,width:width-212,borderTopLeftRadius:10}} onPress={()=>setMultiWayDropdownOne(true)}>
                     <View>
                      <Text style={{borderWidth:1,borderColor:'transparent',fontSize:20,fontWeight:'bold',left:'2%',color:'rgba(190, 122, 68,0.9)',height:height*0.027,width:width-215}} >From</Text>
                     <View style={{borderWidth:1,borderColor:'transparent',height:height*0.03,width:width-320,top:'5%',alignSelf:'center'}}> <Text style={{textAlign:'center',fontSize:22,fontWeight:'bold',color:'rgba(31, 31, 31,0.9)'}}>{multiWayDropdownLabelOne}</Text></View>
                      <Text style={{fontSize:15,borderWidth:1,borderColor:'transparent',textAlign:'center',height:height*0.045,top:'10%',color:'rgba(31, 31, 31,0.9)'}}>{multiWayDropdownValueOne}</Text>
                     </View>
                    </TouchableOpacity>
                    <TouchableOpacity style={{borderWidth:0.5,height:height*0.122,width:width-212,borderTopRightRadius:10}} onPress={()=>setMultiWayDropdownTwo(true)}>
                    <View>
                      <Text  style={{borderWidth:1,borderColor:'transparent',fontSize:20,fontWeight:'bold',left:'2%',color:'rgba(190, 122, 68,0.9)',height:height*0.027,width:width-215}}>To</Text>
                      <View style={{borderWidth:1,borderColor:'transparent',height:height*0.03,width:width-320,top:'5%',alignSelf:'center'}}><Text style={{textAlign:'center',fontSize:22,fontWeight:'bold',color:'rgba(31, 31, 31,0.9)'}}>{multiWayDropdownLabelTwo}</Text></View>
                      <Text style={{fontSize:15,borderWidth:1,borderColor:'transparent',textAlign:'center',height:height*0.045,top:'10%',color:'rgba(31, 31, 31,0.9)'}}>{multiWayDropdownValueTwo}</Text>
                     </View>
                    </TouchableOpacity>
                   </View>
                   <View style={{flexDirection:'row',justifyContent:'space-between'}}>
                   <TouchableOpacity style={{borderWidth:0.2,height:height*0.125,width:width-287}} onPress={()=>setMultiWayCalenderOne(true)}>
                    <View>
                    <Text style={{borderWidth:1,borderColor:'transparent',fontSize:20,fontWeight:'bold',left:'2%',color:'rgba(190, 122, 68,0.9)',height:height*0.032,width:width-287}}>Departure</Text>
                    <Text style={{borderWidth:1,borderColor:'transparent',fontSize:20,top:'8%',fontWeight:'bold',textAlign:'center',color:'rgba(31, 31, 31,0.9)'}}>{multiWayCalendarLabelOne}</Text>
                   <Text style={{borderWidth:1,borderColor:'transparent',fontSize:20,top:'8%',textAlign:'center',color:'rgba(31, 31, 31,0.9)'}}>{multiWayCalendarValueOne}</Text> 
                    </View>
                   </TouchableOpacity>
                   <TouchableOpacity style={{borderWidth:0.2,height:height*0.125,width:width-287}} onPress={()=>setMultiWayCalendarTwo(true)} >
                   <Text style={{borderWidth:1,borderColor:'transparent',fontSize:20,fontWeight:'bold',left:'2%',color:'rgba(190, 122, 68,0.9)',height:height*0.032,width:width-287}}>Return</Text>
              <Text style={{borderWidth:1,borderColor:'transparent',fontSize:20,top:'8%',fontWeight:'bold',textAlign:'center',color:'rgba(31, 31, 31,0.9)'}}>{multiWayCalendarLabelTwo}</Text>
              <Text style={{borderWidth:1,borderColor:'transparent',fontSize:20,top:'8%',textAlign:'center',color:'rgba(31, 31, 31,0.9)'}}>{multiWayCalendarValueTwo}</Text>
                   </TouchableOpacity> 
                   <TouchableOpacity style={{borderWidth:0.2,height:height*0.125,width:width-260}} onPress={()=>setMultiNoOfTravellers(true)}>
                   <Text style={{borderWidth:1,borderColor:'transparent',fontSize:16,left:'1%',textAlign:'center',width:width-260,fontWeight:'bold',color:'rgba(190, 122, 68,0.9)'}}>Travellers & Cabin Class</Text>
            <Text style={{borderWidth:1,borderColor:'transparent',fontSize:15,alignSelf:'center',height:height*0.020,width:width-285,fontWeight:'bold',textAlign:'center',color:'rgba(31, 31, 31,0.9)' }}>{countMultitravellers}</Text>
            <Text style={{borderWidth:1,borderColor:'transparent',fontSize:16,height:height*0.045,width:width-275,alignSelf:'center',alignContent:'center',alignItems:'center',fontWeight:'bold',textAlign:'center'}}>{showMultiCabinClass}</Text>
                   </TouchableOpacity>
                   </View>
      ...
      {noOfTravellers&&(
        ...
        <View style={{position:'absolute',borderWidth:1,borderColor:"transparent",borderRadius:10,height:height*0.25,top:'22.5%',alignSelf:"flex-end",right:'2%',}}>
      <View style={{borderWidth:1,borderColor:"transparent",height:height*0.04,width:width-300,alignSelf:'flex-end',right:'5%'}}>
        <View style={{borderWidth:0.5,borderColor:'rgba(31, 31, 31,0.9)',height:height*0.04,width:width-370,transform:[{rotate:'43deg'}],top:'62%',left:'30%',backgroundColor:'rgb(240, 240, 240)',elevation:14}}/>
        </View>
        <View style={{borderWidth:0.5,borderColor:'rgba(31, 31, 31,0.9)',backgroundColor:'rgb(240, 240, 240)',height:height*0.22,width:width-100,borderRadius:10,alignSelf:'flex-end',justifyContent:'space-between',elevation:14}}>
          <ScrollView>
          <View style={{height:height*0.69,width:width-100}}>
           <View style={{borderWidth:1,borderColor:'transparent',top:'2%',borderRadius:10,height:height*0.062,width:width-120,alignSelf:'center',flexDirection:'row',justifyContent:'space-between'}}>
            <View style={{borderWidth:1,borderColor:'transparent',height:height*0.062,width:width-310,alignSelf:'flex-start'}}>
            <Text style={{borderWidth:1,borderColor:'transparent',height:height*0.03,width:width-270,fontSize:20,fontWeight:'bold',left:'7%'}}>Adults</Text>
            <Text style={{borderWidth:1,borderColor:'transparent',height:height*0.03,width:width-270,fontSize:18}}>(12+Years)</Text>
            </View>
            <View style={{borderWidth:1,borderRadius:10,flexDirection:'row',alignSelf:'center',height:height*0.050,width:width-270,justifyContent:'space-between',alignContent:'center',alignItems:'center',right:'2%'}}>
            <TouchableOpacity style={{borderWidth:1,borderTopLeftRadius:10,borderBottomLeftRadius:10,height:height*0.050,width:width-365,alignSelf:"center",alignContent:'center',alignItems:'center',backgroundColor:'#fff'}} onPress={()=>MinusFunction('adult')}><Icon name='minimize' size={25}  color={'#000'}/></TouchableOpacity>
           <View style={{borderWidth:1,height:height*0.050,width:width-365,alignSelf:'center',justifyContent:'center',alignContent:'center',alignItems:'center',backgroundColor:"rgba(219, 188, 160,0.4)"}}> <Text style={{textAlign:'center',fontSize:18,fontWeight:'bold',color:'rgba(31, 31, 31,0.9)'}}>{adultNo}</Text></View>
           <TouchableOpacity style={{borderWidth:1,borderTopRightRadius:10,borderBottomRightRadius:10,height:height*0.050,width:width-365,alignSelf:'center',justifyContent:'center',alignContent:'center',alignItems:'center',backgroundColor:'#fff'}} onPress={()=>PlusFunction('adult')}> <Icon name='add' size={20}  color={'#000'}/></TouchableOpacity>
            </View>
            </View>
            <View style={{borderWidth:1,borderColor:'transparent',top:'6%',borderRadius:10,height:height*0.062,width:width-120,alignSelf:'center',flexDirection:'row',justifyContent:'space-between'}}>
            <View style={{borderWidth:1,borderColor:'transparent',height:height*0.062,width:width-310,alignSelf:'flex-start'}}>
            <Text style={{borderWidth:1,borderColor:'transparent',height:height*0.03,width:width-270,fontSize:20,fontWeight:'bold',left:'5%'}}>Children</Text>
            <Text style={{borderWidth:1,borderColor:'transparent',height:height*0.03,width:width-270,fontSize:18}}>(2-12Years)</Text>
            </View>
            <View style={{borderWidth:1,borderRadius:10,flexDirection:'row',alignSelf:'center',height:height*0.050,width:width-270,justifyContent:'space-between',alignContent:'center',alignItems:'center',right:'2%'}}>
            <TouchableOpacity style={{borderWidth:1,borderTopLeftRadius:10,borderBottomLeftRadius:10,height:height*0.050,width:width-365,alignSelf:'center',alignContent:'center',alignItems:'center',backgroundColor:'#fff'}}  onPress={()=>MinusFunction('child')}><Icon name='minimize' size={25}  color={'#000'} /></TouchableOpacity>
            <View style={{borderWidth:1,height:height*0.050,width:width-365,alignSelf:'center',justifyContent:'center',alignContent:'center',alignItems:'center',backgroundColor:"rgba(219, 188, 160,0.4)"}}> <Text style={{textAlign:'center',fontSize:18,fontWeight:'bold',color:'rgba(31, 31, 31,0.9)'}}>{childNo}</Text></View>
           <TouchableOpacity style={{borderWidth:1,borderTopRightRadius:10,borderBottomRightRadius:10,height:height*0.050,width:width-365,alignSelf:'center',justifyContent:'center',alignContent:'center',alignItems:'center',backgroundColor:'#fff'}}  onPress={()=>PlusFunction('child')}> <Icon name='add' size={20}  color={'#000'}/></TouchableOpacity>
            </View>
            </View>
            <View style={{borderWidth:1,borderColor:'transparent',top:'10%',borderRadius:10,height:height*0.062,width:width-120,alignSelf:'center',flexDirection:'row',justifyContent:'space-between'}}>
            <View style={{borderWidth:1,borderColor:'transparent',height:height*0.062,width:width-310,alignSelf:'flex-start'}}>
            <Text style={{borderWidth:1,borderColor:'transparent',height:height*0.03,width:width-270,fontSize:20,fontWeight:'bold',left:'7%'}}>Babies</Text>
            <Text style={{borderWidth:1,borderColor:'transparent',height:height*0.03,width:width-270,fontSize:18}}>(0-2Years)</Text>
            </View>
            <View style={{borderWidth:1,borderRadius:10,flexDirection:'row',alignSelf:'center',height:height*0.050,width:width-270,justifyContent:'space-between',alignContent:'center',alignItems:'center',right:'2%'}}>
            <TouchableOpacity style={{borderWidth:1,borderTopLeftRadius:10,borderBottomLeftRadius:10,height:height*0.050,width:width-365,alignSelf:'center',alignContent:'center',alignItems:'center',backgroundColor:'#fff'}}  onPress={()=>MinusFunction('infant')}><Icon name='minimize' size={25}  color={'#000'} onPress={PlusFunction}/></TouchableOpacity>
           <View style={{borderWidth:1,height:height*0.050,width:width-365,alignSelf:'center',justifyContent:'center',alignContent:'center',alignItems:'center',backgroundColor:"rgba(219, 188, 160,0.4)"}}> <Text style={{textAlign:'center',fontSize:18,fontWeight:'bold',color:'rgba(31, 31, 31,0.9)'}}>{infantNo}</Text></View>
           <TouchableOpacity style={{borderWidth:1,borderTopRightRadius:10,borderBottomRightRadius:10,height:height*0.050,width:width-365,alignSelf:'center',justifyContent:'center',alignContent:'center',alignItems:'center',backgroundColor:'#fff'}} onPress={()=>PlusFunction('infant')}> <Icon name='add' size={20}  color={'#000'}/></TouchableOpacity>
            </View>
            </View> 
           <View style={{borderWidth:1,borderColor:'transparent',height:height*0.06,top:'15%',width:width-100,alignSelf:'center',alignContent:'center',alignItems:'center',justifyContent:'center',backgroundColor:'rgba(219, 188, 160,0.9)'}}>
           <Text style={{textAlign:'center',fontSize:16.2,fontWeight:'bold'}}>At A Time Eight Travellers Book Only</Text></View>
           ...
           layout='column'
           labelStyle={{fontStyle:'italic',fontWeight:'bold',color:'#000',fontSize:20}}
           containerStyle={{height:height*0.15,borderWidth:0.5,borderColor:'transparent',width:width-205,alignSelf:'flex-start',justifyContent:'flex-start',alignContent:'flex-start',alignItems:'flex-start'}}
          />
           </View>
           {tranvellersError&&(
           ...
           <TouchableOpacity style={{height:height*0.065,width:width-135,borderWidth:1,borderRadius:10,top:'25%',alignSelf:'center',borderColor:'rgba(190, 122, 68,0.9)',alignContent:'center',alignItems:'center',justifyContent:'center'}} onPress={travellerfunctions}>
            <Text style={{fontSize:30,color:"rgba(190, 122, 68,0.9)",fontWeight:'bold'}}>Done</Text>
           </TouchableOpacity>
           </View>
            </ScrollView>
          </View>
  ...
  {showCalendar&&(
      <View style={{borderWidth:1,borderColor:'transaprent',height:height*0.4,width:width-440,alignSelf:'flex-start',position:"absolute",top:'16%',elevation:10}}>
    <Calendar
    style={{height:height*0.4,width:width-185,fontSize:20,backgroundColor:'rgb(104, 102, 102)'}}
    theme={{calendarBackground:'darkgrey',
      textMonthFontWeight: 'bold',
      textMonthFontSize:12,
      monthTextColor:'rgb(10, 57, 110)',
      textMonthBorderWidth:1,
        arrowColor: '#000',
        arrowStyle: {borderColor:'transparent',height:height*0.05,left:'5%',width:width-800,borderWidth:1,arrowSize:20,alignSelf:'center',right:0,marginHorizontally:'20%'},
        textDayFontSize: 14, // Day numbers font size
        dayTextColor: '#000', // Day numbers text color
        ...
        textSectionTitleColor: '#000', // Day header text color
      }}
   ...
   {showSecCalendar&&(
    <View style={{borderWidth:1,borderColor:'transaprent',height:height*0.4,width:width-440,alignSelf:'center',position:"absolute",top:'16%',elevation:10}}>
    <Calendar
    style={{height:height*0.4,width:width-185,fontSize:20,backgroundColor:'rgb(104, 102, 102)'}} 
    theme={{ 
    ...
    markedDates={{
      ...
      {multiNoOfTravellers&&(
        <View style={{position:'absolute',borderWidth:1,borderColor:"transparent",borderRadius:10,height:height*0.25,top:'45%',alignSelf:"flex-end",right:'2%'}}>
      <View style={{borderWidth:1,borderColor:"transparent",height:height*0.04,width:width-300,alignSelf:'flex-end',right:'5%'}}>
        <View style={{borderWidth:0.5,borderColor:'rgba(31, 31, 31,0.9)',height:height*0.04,width:width-370,transform:[{rotate:'43deg'}],top:'62%',left:'30%',backgroundColor:'rgb(240, 240, 240)',elevation:14}}/>
        </View>
        <View style={{borderWidth:0.5,borderColor:'rgba(31, 31, 31,0.9)',backgroundColor:'rgb(240, 240, 240)',height:height*0.22,width:width-100,borderRadius:10,alignSelf:'flex-end',justifyContent:'space-between',elevation:14}}>
          ...
          <View style={{height:height*0.69,width:width-100}}>
           <View style={{borderWidth:1,borderColor:'transparent',top:'2%',borderRadius:10,height:height*0.062,width:width-120,alignSelf:'center',flexDirection:'row',justifyContent:'space-between'}}>
            ...
            <View style={{borderWidth:1,borderRadius:10,flexDirection:'row',alignSelf:'center',height:height*0.050,width:width-270,justifyContent:'space-between',alignContent:'center',alignItems:'center',right:'2%'}}>
            <TouchableOpacity style={{borderWidth:1,borderTopLeftRadius:10,borderBottomLeftRadius:10,height:height*0.050,width:width-365,alignSelf:"center",alignContent:'center',alignItems:'center',backgroundColor:'#fff'}} onPress={()=>MinusMultiFunction('adult')}><Icon name='minimize' size={25}  color={'#000'}/></TouchableOpacity>
           <View style={{borderWidth:1,height:height*0.050,width:width-365,alignSelf:'center',justifyContent:'center',alignContent:'center',alignItems:'center',backgroundColor:"rgba(219, 188, 160,0.4)"}}> <Text style={{textAlign:'center',fontSize:18,fontWeight:'bold',color:'rgba(31, 31, 31,0.9)'}}>{adultMultiNo}</Text></View>
           <TouchableOpacity style={{borderWidth:1,borderTopRightRadius:10,borderBottomRightRadius:10,height:height*0.050,width:width-365,alignSelf:'center',justifyContent:'center',alignContent:'center',alignItems:'center',backgroundColor:'#fff'}} onPress={()=>PlusMultiFunction('adult')}> <Icon name='add' size={20}  color={'#000'}/></TouchableOpacity>
            </View>
            </View>
            <View style={{borderWidth:1,borderColor:'transparent',top:'6%',borderRadius:10,height:height*0.062,width:width-120,alignSelf:'center',flexDirection:'row',justifyContent:'space-between'}}>
            <View style={{borderWidth:1,borderColor:'transparent',height:height*0.062,width:width-310,alignSelf:'flex-start'}}>
            ...
            <View style={{borderWidth:1,borderRadius:10,flexDirection:'row',alignSelf:'center',height:height*0.050,width:width-270,justifyContent:'space-between',alignContent:'center',alignItems:'center',right:'2%'}}>
            <TouchableOpacity style={{borderWidth:1,borderTopLeftRadius:10,borderBottomLeftRadius:10,height:height*0.050,width:width-365,alignSelf:'center',alignContent:'center',alignItems:'center',backgroundColor:'#fff'}}  onPress={()=>MinusMultiFunction('child')}><Icon name='minimize' size={25}  color={'#000'} /></TouchableOpacity>
            <View style={{borderWidth:1,height:height*0.050,width:width-365,alignSelf:'center',justifyContent:'center',alignContent:'center',alignItems:'center',backgroundColor:"rgba(219, 188, 160,0.4)"}}> <Text style={{textAlign:'center',fontSize:18,fontWeight:'bold',color:'rgba(31, 31, 31,0.9)'}}>{childMultiNo}</Text></View>
           <TouchableOpacity style={{borderWidth:1,borderTopRightRadius:10,borderBottomRightRadius:10,height:height*0.050,width:width-365,alignSelf:'center',justifyContent:'center',alignContent:'center',alignItems:'center',backgroundColor:'#fff'}}  onPress={()=>PlusMultiFunction('child')}> <Icon name='add' size={20}  color={'#000'}/></TouchableOpacity>
            </View>
            </View>
            <View style={{borderWidth:1,borderColor:'transparent',top:'10%',borderRadius:10,height:height*0.062,width:width-120,alignSelf:'center',flexDirection:'row',justifyContent:'space-between'}}>
            <View style={{borderWidth:1,borderColor:'transparent',height:height*0.062,width:width-310,alignSelf:'flex-start'}}>
            ...
            <View style={{borderWidth:1,borderRadius:10,flexDirection:'row',alignSelf:'center',height:height*0.050,width:width-270,justifyContent:'space-between',alignContent:'center',alignItems:'center',right:'2%'}}>
            <TouchableOpacity style={{borderWidth:1,borderTopLeftRadius:10,borderBottomLeftRadius:10,height:height*0.050,width:width-365,alignSelf:'center',alignContent:'center',alignItems:'center',backgroundColor:'#fff'}}  onPress={()=>MinusMultiFunction('infant')}><Icon name='minimize' size={25}  color={'#000'} /></TouchableOpacity>
           <View style={{borderWidth:1,height:height*0.050,width:width-365,alignSelf:'center',justifyContent:'center',alignContent:'center',alignItems:'center',backgroundColor:"rgba(219, 188, 160,0.4)"}}> <Text style={{textAlign:'center',fontSize:18,fontWeight:'bold',color:'rgba(31, 31, 31,0.9)'}}>{infantMultiNo}</Text></View>
           <TouchableOpacity style={{borderWidth:1,borderTopRightRadius:10,borderBottomRightRadius:10,height:height*0.050,width:width-365,alignSelf:'center',justifyContent:'center',alignContent:'center',alignItems:'center',backgroundColor:'#fff'}} onPress={()=>PlusMultiFunction('infant')}> <Icon name='add' size={20}  color={'#000'}/></TouchableOpacity>
            </View>
            </View> 
           <View style={{borderWidth:1,borderColor:'transparent',height:height*0.06,top:'15%',width:width-100,alignSelf:'center',alignContent:'center',alignItems:'center',justifyContent:'center',backgroundColor:'rgba(219, 188, 160,0.9)'}}>
           <Text style={{textAlign:'center',fontSize:16.2,fontWeight:'bold'}}>At A Time Eight Travellers Book Only</Text></View>
          ...
          />
           ...
           <TouchableOpacity style={{height:height*0.065,width:width-135,borderWidth:1,borderRadius:10,top:'25%',alignSelf:'center',borderColor:'rgba(190, 122, 68,0.9)',alignContent:'center',alignItems:'center',justifyContent:'center'}} onPress={multitravellerfunctions}>
            <Text style={{fontSize:30,color:"rgba(190, 122, 68,0.9)",fontWeight:'bold'}}>Done</Text>
           </TouchableOpacity>
           </View>
            </ScrollView>
